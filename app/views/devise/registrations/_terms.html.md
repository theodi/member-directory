1. Introduction
    1. This Agreement is made between <%= member.name %> (“You” or “Your”) and the ODI and will govern the ODI’s relationship with you whilst you are a <%= @product_name %> of the ODI. 
...
2. Definitions
    ...
    | You/Your | means <%= member.name %> being a company registered in England and Wales with company number <%= member.company_number %> and whose registered office is <%= member.address %> |
...
9. Termination of Membership
    1. Without prejudice to any other rights or remedies which the ODI may have, the ODI may terminate this Agreement with immediate effect if:
        ...
        2. The ODI’s board, in its sole discretion, dictates this Agreement must be terminated.
